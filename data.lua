...
if settings.startup["basic-robots-enable-roboport"].value or settings.startup["basic-robots-enable-logistics"].value then
  -- Containers
...
data:extend{e,
  {
    ...
    icon_size = 64, icon_mipmaps = 4,
    placed_as_equipment_result = "basic-robots-personal-roboport-equipment",
    subgroup = "equipment",
...
data:extend{
  ...
  },
  {
    ...
    icon_size = 64, icon_mipmaps = 4,
    placed_as_equipment_result = "basic-robots-battery-holder-equipment",
    subgroup = "equipment",
    order = "e[robotics]-a[personal-roboport-equipment]",
    default_request_amount = 1,
    stack_size = 20
...
if settings.startup["basic-robots-enable-logistics"].value then
  table.insert(data.raw.technology["basic-robots-robotics"].effects, { type = "unlock-recipe", recipe = "basic-robots-logistic-robot" })
  table.insert(data.raw.technology["basic-robots-robotics"].effects, { type = "character-logistic-requests", modifier = true })
  table.insert(data.raw.technology["basic-robots-robotics"].effects, { type = "character-logistic-trash-slots", modifier = 30 })
...
if settings.startup["basic-robots-enable-logistics"].value and settings.startup["basic-robots-enable-roboport"] then
  table.insert(data.raw.technology["basic-robots-robotics"].effects, { type = "unlock-recipe", recipe = "basic-robots-logistic-chest-passive-provider" })
  table.insert(data.raw.technology["basic-robots-robotics"].effects, { type = "unlock-recipe", recipe = "basic-robots-logistic-chest-storage" })
end
